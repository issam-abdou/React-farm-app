...
export default function Header() {
  return (
<header>
    <div className="top__nav  position-sticky">
    ...
    <nav className="navbar navbar-expand-lg  text-white position-sticky">
        <div className="container ">
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav ms-auto gap-2 mt-3 mt-md-0 pb-4 pb-md-0">
              ...
              <a className="nav-link " href="#about">Qui somme nous</a>
              <a className="nav-link " href="#why-us">Pourquoi nous</a>
              <a className="nav-link" href="#products">Nos Produits</a>
              <a className="nav-link ps-2 pe-2 fw-bold nav-btn text-center" href="#contact">Contactez nous</a>
